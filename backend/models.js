...
const UserSchema = new Schema({
  ...
  // ⚠️ Телефон теперь НЕ обязателен, чтобы signup не падал
  phone:        { type: String, default: '' },

  isAdmin:      { type: Boolean, default: false }, // для обратной совместимости
...
UserSchema.index({ tenantId: 1, phone: 1 }, { unique: true, partialFilterExpression: { phone: { $type: 'string', $ne: '' } } });
