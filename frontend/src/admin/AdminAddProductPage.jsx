...
export default function AdminAddProductPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const setters = {
        ...
        price: setPrice, currency: setCurrency, unit: setUnit, stock: setStock, stockState: setStockState,
  ...
  /* ----- Цена: маска и блокировка мусорных клавиш ----- */
  ...
  const blockBadKeys = (e) => {
    ...
    // стопим, чтобы редактор описания не ловил хоткеи
    e.stopPropagation();
  };
