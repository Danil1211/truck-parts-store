...
/* Небольшие inline-SVG иконки (стабильные) */
function Icon({ name }) {
  const p = {
    width: 22,
    height: 22,
    ...
    case "settings":
      return (
        <svg {...p}>
          ...
          <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06A1.65 1.65 0 0 0 15 19.4a1.65 1.65 0 0 0-1 .6 1.65 1.65 0 0 0-.33 1.82l.02.06a2 2 0 1 1-3.78 0l.02-.06a1.65 1.65 0 0 0-.33-1.82 1.65 1.65 0 0 0-1-.6 1.65 1.65 0 0 0-1.82.33l-.06.06A2 2 0 1 1 2.9 17l.06-.06A1.65 1.65 0 0 0 3.6 15" />
        </svg>
      );
    default:
      return null;
  ...
  return (
    <div className="admin-root admin-layout">
      ...
      <aside className="admin-sidebar" aria-label="Меню разделов">
        ...
        {/* Можно оставить место под дополнительную кнопку */}
      ...
      <main
        ...
        role="main"
      >
        {/* На страницах orders/products сами компоненты выводят
            своё фиксированное правое подменю (.admin-nav-menu). */}
        <Outlet />
      </main>
    </div>
  );
